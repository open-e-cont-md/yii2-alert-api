...
use openecontmd\alert_api\models\BankInvoiceAPI;
 ...
 *              @OA\Examples(example="result_invoice", value={
 ...
 "controller": "invoice",
 "entry_point": "https://api.open.e-cont.md/bank/v1/invoice/{action}"
 }
	...
	public function actionIndex()
	{
	    return [
	        'available_actions' => [
	            ...
	            'set-identifier'],
	        'controller' => 'invoice',
	        'entry_point' => 'https://api.open.e-cont.md/alert/v1/invoice/{action}',
	    ];
	}

/** Set Invoice Number
 * @OA\Post(
 *     path="/alert/v1/invoice/set-invoice-number",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
...
/** Set Issue Date
 * @OA\Post(
 *     path="/alert/v1/invoice/set-issue-date",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
...
/** Set Due Date
 * @OA\Post(
 *     path="/alert/v1/invoice/set-due-date",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact Name
 * @OA\Post(
 *     path="/alert/v1/invoice/set-contact-name",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
...
/** Set Contact E-Mail
 * @OA\Post(
 *     path="/alert/v1/invoice/set-contact-email",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
...
/** Set Identifier
 * @OA\Post(
 *     path="/alert/v1/invoice/set-identifier",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
...
/** Create Invoice
 * @OA\Post(
 *     path="/alert/v1/invoice/create-invoice",
 *     method="post",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	public function actionCreateInvoice()
	{
	    ...
	    $r1 = BankInvoiceAPI::checkInvoiceByNumber($id);
	    if ($r1) {
	        throw new HttpException(401, 'Повторный номер инвойса');
	    }
	    else {
	        $uid = BankInvoiceAPI::createUid();
	        $r2 = BankInvoiceAPI::createInvoice($uid, $id, $ubl_document);
	    }
 ...
 * @OA\Post(
 *     path="/alert/v1/invoice/create-invoice-by-object",
 *     tags={"alert"},
 ...
 * @OA\Post(
 *     path="/alert/v1/invoice/create-party-by-object",
 *     tags={"alert"},
...
/** Get Party By Id
 * @OA\Post(
 *     path="/alert/v1/invoice/get-party-by-id",
 *     method="post",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
 ...
 * @OA\Post(
 *     path="/alert/v1/invoice/get-invoice-by-number",
 *     method="post",
 *     tags={"alert"},
 *     @OA\Response(
 *         response="200",
 ...
 */
	...
	{
	    $id = Yii::$app->request->get('id');
	    $r1 = BankInvoiceAPI::getInvoiceByNumber($id);
