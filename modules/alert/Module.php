...
namespace openecontmd\alert_api\modules\alert;

use Yii;
use yii\filters\VerbFilter;
//use yii\web\BadRequestHttpException;
use openecontmd\alert_api\models\validation\ApiRequest;
use yii\web\HttpException;

class Module extends \yii\base\Module
{
	public $controllerNamespace = 'openecontmd\alert_api\modules\alert\controllers';
	public $gate = null;
...
//		$this->gate = Yii::$app->session->get('gate');
		...
		//$this->_check_token();
		//		$method = str_replace('alert/v1/', '', $this->module->requestedRoute);
